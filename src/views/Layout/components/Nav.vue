...
<div><footer id="footer">
			<ul>
				<router-link tag="li" to="/movies"><i class="iconfont icon-dianying"></i>
					<p>电影</p></router-link>
				<router-link tag="li" to="/cinema"><i class="iconfont icon-dianying"></i>
					<p>影院</p></router-link>
                <router-link tag="li" to="/mine"><i class="iconfont icon-dianying"></i>
					<p>我的</p></router-link>
			</ul>
		</footer></div>
